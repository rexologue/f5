...
from .preprocess import SAMPLE_RATE, load_audio, FeatureExtractor
from .encoder import ConformerEncoder
from .decoder import CTCHead 
from .decoding import CTCGreedyDecoding
...
class GigaAM(nn.Module):
    ...
    def __init__(self, cfg: omegaconf.DictConfig):
        super().__init__()
        self.cfg = cfg
        self.preprocessor = FeatureExtractor(**self.cfg.preprocessor)
        self.encoder = ConformerEncoder(**self.cfg.encoder)
...
class GigaAMASR(GigaAM):
    ...
    def __init__(self, cfg: omegaconf.DictConfig):
        super().__init__(cfg)
        self.head = CTCHead(**self.cfg.head)
        self.decoding = CTCGreedyDecoding(**self.cfg.decoding)
