...
from .decoding import Tokenizer, CTCGreedyDecoding
...
def infer_onnx(
    ...
    if preprocessor is None:
        preprocessor = FeatureExtractor(**model_cfg.preprocessor)
    if tokenizer is None and ("ctc" in model_name or "rnnt" in model_name):
        tokenizer = CTCGreedyDecoding(**model_cfg.decoding).tokenizer
